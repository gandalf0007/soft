...
<div class="form-horizontal">
	...
	{!!Form::text('pro_venta',null,['class'=>'form-control','placeholder'=>'ingrese el telefono'])!!}
</div>
...
<div class="form-horizontal">
	...
	{!!Form::textarea ('pro_observaciones',null,['class'=>'form-control','placeholder'=>'ingrese el telefono'])!!}
</div>
