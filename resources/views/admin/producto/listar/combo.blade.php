...
<!--buscador-->
{!!Form::open(['url'=>'producto-combo', 'method'=>'GET' , 'class'=>'navbar-form navbar-left' , 'role'=>'Search'])!!}
...
<td>
<a class="btn btn-warning btn-lg fa fa-eye" href="{{ URL::to('producto-combo-ver-'.$producto->id) }}"></a>

<a class="btn btn-success btn-lg fa fa-picture-o" href="{!! URL::to('producto-uploadimagen/'.$producto->id) !!}"></a>


<a class="btn btn-primary btn-lg fa fa-edit" href="{{ URL::to('producto-combo-edit-'.$producto->id) }}"></a>
...
<!--para el metodo eliminar necesito de un formulario para ejecutarlo-->
 <button type="button" class="btn btn-danger btn-lg fa fa-trash-o" data-toggle="modal" data-target="#confirmDeleteCombo-{{ $producto->id }}"></button>
@endif
...
<!--modal de eliminar producto-->
 @include('admin.producto.modal.modal-delete-producto-combo')
