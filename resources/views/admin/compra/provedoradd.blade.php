...
{!! Form::open(array('url' => 'compra-addprovedor', 'method'=>'GET', 'class'=>'navbar-form navbar-left' , 'role'=>'Search' )) !!}
<div class="form-group">
	{!!Form::label('nombre')!!}
	{!!Form::text('razonsocial',null,['class'=>'form-control','placeholder'=>'nombre del provedor'])!!}
