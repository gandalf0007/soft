...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="{{ url('reparaciones-completados') }}">Reparaciones Completados  ({{$count}})</a></li>
...
<table id="example2" class="table table-bordered table-hover">
  ...
  <td>
      <a href="#status-{{ $reparacione->id }}" data-toggle="modal" ><span class="label label-success">{{ $reparacione -> status }}</span></a>
  </td>
