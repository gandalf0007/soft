...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
	...
	<div class="row">
	 ...
	 <div class=" myaccount col-sm-12 col-md-12 user-details ">
...
<div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        <td>Nombre: {{ $datosfacturacions->nombre }}</td>
                        <td>Apellido: {{ $datosfacturacions->apellido }}</td>
                      </tr>
                      <tr>
                        <td>Cuit: {{ $datosfacturacions->cuit }} </td>
                        <td>Direccion: {{ $datosfacturacions->direccion }}</td>
                      </tr>
                      <tr>
                        <td>Telefono: {{ $datosfacturacions->telefono }}</td>
                        <td>Telefono 2:{{ $datosfacturacions->telefono2 }}</td>
                      </tr>
                   
                         <tr>
                             
                        <tr>
                        <td>Ciudad: {{ $datosfacturacions->ciudad }}</td>
                        <td>Provincia: {{ $datosfacturacions->provincia }}</td>
                      </tr>
                      <tr>
                        <td>Codigo Postal: {{ $datosfacturacions->cp }}</td>
                       <td>Fecha de Nacimiento: {{ $datosfacturacions->nacimiento }}</td>
                      </tr>                       
                        <td>Empresa : @if( $datosfacturacions->empresa == "1") 
                                          SI
                                      @else
                                          NO
                                      @endif
